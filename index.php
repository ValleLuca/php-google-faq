...
$Alunni = [
    ...
    [
        ...
        'Risposta' => 'Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose: "<br>" La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti: "<br>" Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera. "<br>" Google LLC, con sede negli Stati Uniti, per il resto del mondo. "<br>" La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali. "<br>" Tieni presente che i servizi Google sono fondamentalmente gli stessi a prescindere dalla società consociata che li offre o dal paese a cui è associato il tuo account.',
    ], 
    [
