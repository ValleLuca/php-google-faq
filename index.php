...
$DomandeArr = [
    ...
    [
        'Domanda' => '<h4>Come state implementando la recente decisione della Corte di giustizia dell\'Unione europea (CGUE) relativa al diritto all\'oblio?</h4>',
    ...
    [
        ...
        'Risposta' => '<p>Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:<br><ol><li>La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:</li><br><ol type="a"><li>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</li><br><li>Google LLC, con sede negli Stati Uniti, per il resto del mondo.</li></ol><br><li>La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.</li></ol><br>Tieni presente che i servizi Google sono fondamentalmente gli stessi a prescindere dalla società consociata che li offre o dal paese a cui è associato il tuo account.</p>',
    ], 
    [
        'Domanda' => '<h4>Stabilire il paese associato al tuo account</h4>',
        'Risposta' => '<p>Quando crei un nuovo Account Google, lo associamo a un paese in base a dove è stato creato. Per quanto riguarda gli account creati almeno un anno fa, usiamo il paese da cui accedi solitamente ai servizi Google, in genere i servizi in cui hai trascorso più tempo nell\'ultimo anno.<br>I viaggi frequenti solitamente non influiscono sul paese associato al tuo account. Se ti trasferisci in un altro paese, potrebbe occorrere circa un anno per aggiornare l \'associazione del paese.<br>Se il paese associato al tuo account non corrisponde al tuo paese di residenza, il motivo potrebbe essere la differenza tra il paese in cui lavori e il paese in cui risiedi, l\'installazione di una rete privata virtuale (VPN) per mascherare il tuo indirizzo IP oppure la residenza vicino a un confine territoriale. Contattaci se ritieni che il paese associato al tuo account sia sbagliato.</p>',
    ],
    [
...
<head>
    ...
    <title>Domande Utente Google</title>
</head>
<body>

    <div style="border-bottom: 1px solid black;" class="p-2">
        <div class="d-flex justify-content-between align-items-center p-2">
            <div class="ms-4">
                <img style="height:40px" class="p-1" src="https://www.bildersuche.org/images/logos/google-logo-thumb.png">
                <a href="#" style="text-decoration-line: none; color: black; font-size: 22px;">Privaci e Termini</a>
            </div>
            <div>
                <i class="fa-solid fa-list-ul p-1"></i>
                <i class="fa-solid fa-user p-1"></i>
            </div>
        </div>

        <ul class="d-flex" style="list-style-type: none;">
            <li class="me-4" style="cursor: pointer;";>Introduzione</li>
            <li class="me-4" style="cursor: pointer;";>Norme sulla privacy</li>
            <li class="me-4" style="cursor: pointer;";>Termini di servizio</li>
            <li class="me-4" style="cursor: pointer;";>Tecnologie</li>
            <li style="cursor: pointer; color: blue; border-bottom: 1px solid blue;"; class="pb-3">Domande frequenti</li>
        </ul>
    </div>
    ...
    <div class="container p-5">
        <div class="row">
            <?php
                foreach($DomandeArr as $Faq ){
                    foreach($Faq as $key => $testo){
                        if($key == 'Domanda'){
                            echo $testo;
                        }
                        elseif($key == 'Risposta'){
